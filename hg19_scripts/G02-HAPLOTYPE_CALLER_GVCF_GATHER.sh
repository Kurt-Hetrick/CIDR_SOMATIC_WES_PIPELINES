...
# INPUT VARIABLES
	...
	BAIT_BED=$7 # the input arg is HC_BAIT_BED, BUT IT'S THE SAME FOR THIS PIPELINE
		# trying to keep the different pipelines similarly contructed
		CALL_BED_FILE=${BAIT_BED}

	SAMPLE_SHEET=$8
		SAMPLE_SHEET_NAME=$(basename ${SAMPLE_SHEET} .csv)
	SUBMIT_STAMP=$9

## -----CONCATENATE SCATTERED g.vcf FILES INTO A SINGLE reference sorted g.vcf file-----
