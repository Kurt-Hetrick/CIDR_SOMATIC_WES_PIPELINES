...
# INPUT VARIABLES
	...
	SUBMIT_STAMP=$9
		...
		BAIT_BED_NAME=$(basename ${HC_BAIT_BED} .bed)
			if [[ ${HC_BAIT_BED}="/mnt/research/active/M_Valle_MD_SeqWholeExome_120417_1_GRCh38/BED_Files/BAITS_Merged_S03723314_S06588914_TwistCUEXmito.lift.hg38.merge.clean.bed" \
				|| ${HC_BAIT_BED}="/mnt/research/active/H_Cutting_CFTR_WGHum-SeqCustom_1_Reanalysis/BED_Files_hg38/H_Cutting_phase_1plus2_super_file.bed.lift.hg38.bed" ]];
			then
