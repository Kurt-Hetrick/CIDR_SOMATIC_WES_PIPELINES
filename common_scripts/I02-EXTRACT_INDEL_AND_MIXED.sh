...
START_EXTRACT_INDEL_AND_MIXED=`date '+%s'` # capture time process starts for wall clock tracking purposes.
...
END_EXTRACT_INDEL_AND_MIXED=`date '+%s'` # capture time process stops for wall clock tracking purposes.

# write out timing metrics to file

	echo ${SM_TAG},I01,EXTRACT_INDEL_AND_MIXED,${HOSTNAME},${START_EXTRACT_INDEL_AND_MIXED},${END_EXTRACT_INDEL_AND_MIXED} \
