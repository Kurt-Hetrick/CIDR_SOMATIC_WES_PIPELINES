...
START_GATK_CALC_TUMOR_CONTAM=$(date '+%s')
...
END_GATK_CALC_TUMOR_CONTAM=$(date '+%s') # capture time process stops for wall clock tracking purposes.

# write out timing metrics to file

	echo ${SM_TAG}_${PROJECT}_BAM_REPORTS,F01,GET_PILEUP_SUMMARY,${HOSTNAME},${START_GATK_CALC_TUMOR_CONTAM},${END_GATK_CALC_TUMOR_CONTAM} \
