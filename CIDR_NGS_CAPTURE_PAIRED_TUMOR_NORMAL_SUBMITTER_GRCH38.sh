...
###################
	...
	QC_REPORT=$1 ## THIS IS NOT A QC REPORT. THIS IS THE PAIRED SAMPLE MANIFEST.
	## WHEN I ORIGINALLY DEVELOPED THIS I HAD TO USE A QC REPORT UNTIL THE NEW MANIFEST WAS IMPLEMENTED.
	## I NEVER CHANGED THE NAME OF THE VARIABLE FOR VARIOUS REASONS.
		QC_REPORT_NAME=$(basename ${QC_REPORT} .csv)
	ALLELE_FRACTION_CUTOFF=$2 # AS A FRACTION. THAT IS 0.10 IS 10%. I think using 0.1 or 0.10 should be fine.
		# DEFAULT IS 0.05
...
#####################
	...
	MAFSMITH_CONTAINER="/mnt/research/tools/LINUX/00_GIT_REPO_KURT/CONTAINERS/mafsmith-0.1.0.simg"
...
##################################
	...
	MAKE_PROJ_DIR_TREE ()
	{
		...
		${CORE_PATH}/${SEQ_PROJECT}/REPORTS/{GATK_CALC_TUMOR_CONTAM,LAB_PREP_REPORTS,MAF,MAFSMITH,QC_REPORTS,QC_REPORT_PREP,RG_HEADER} \
...
# build hold id for qc report prep per sample, per project
	...
	BUILD_HOLD_ID_PATH_PROJECT_WRAP_UP ()
	{
		...
		do
			CREATE_TUMOR_SM_TAG_ARRAY
			HOLD_ID_PATH="${HOLD_ID_PATH}Y1_${TUMOR_SM_TAG},"
