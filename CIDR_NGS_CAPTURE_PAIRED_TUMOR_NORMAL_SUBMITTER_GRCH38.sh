...
##############################################################################
	...
	#######################################################
		...
		CALL_MUTECT2 ()
		{
			...
			qsub \
				${AVX_QUEUE_QSUB_ARGS} \
			-N B02-MUTECT2_SCATTER_${TUMOR_INDIVIDUAL}_${TUMOR_SM_TAG}_${TUMOR_PROJECT} \
...
do
	...
	HOLD_ID_PATH_F1R2_GATHER="-hold_jid "
	...
	do
		...
		HOLD_ID_PATH_F1R2_GATHER="${HOLD_ID_PATH_F1R2_GATHER}A01_MUTECT2_${TUMOR_INDIVIDUAL}_${TUMOR_SM_TAG}_chr${CHROMOSOME},"

		HOLD_ID_PATH_F1R2_GATHER=$(echo ${HOLD_ID_PATH_F1R2_GATHER} | sed 's/@/_/g')

		HOLD_ID_PATH_MERGE_STATS="${HOLD_ID_PATH_MERGE_STATS}A01_MUTECT2_${TUMOR_INDIVIDUAL}_${TUMOR_SM_TAG}_chr${CHROMOSOME},"

		HOLD_ID_PATH_MERGE_STATS=$(echo ${HOLD_ID_PATH_MERGE_STATS} | sed 's/@/_/g')

		HOLD_ID_PATH_CAT_MUTECT2_VCF="${HOLD_ID_PATH_CAT_MUTECT2_VCF}A01_MUTECT2_${TUMOR_INDIVIDUAL}_${TUMOR_SM_TAG}_chr${CHROMOSOME},"
