...
-N Y1_${TUMOR_SM_TAG} \
-hold_jid \
B01-CONCORDANCE_HAPLOTYPE_CALLER_${TUMOR_INDIVIDUAL}_${TUMOR_SM_TAG}_${TUMOR_PROJECT},\
E01-VCF_MUTECT2_METRICS_BAIT_${TUMOR_INDIVIDUAL}_${TUMOR_SM_TAG}_${TUMOR_PROJECT},\
E02-VCF_MUTECT2_METRICS_TARGET_${TUMOR_INDIVIDUAL}_${TUMOR_SM_TAG}_${TUMOR_PROJECT} \
-o ${CORE_PATH}/${TUMOR_PROJECT}/LOGS/${TUMOR_INDIVIDUAL}/${TUMOR_INDIVIDUAL}_${TUMOR_SM_TAG}-QC_REPORT_PREP_QC.log \
...
#############################
	...
	CREATE_TUMOR_SM_TAG_ARRAY ()
	{
		TUMOR_INDIVIDUAL_ARRAY=(`awk \
			...
			-v SM_TAG_COLUMN_POSITION="$SM_TAG_COLUMN_POSITION" \
			'BEGIN {FS=",";OFS="\t"} \
			$SM_TAG_COLUMN_POSITION=="'${TUMOR_SM_TAG}'" \
			{split($SUBJECT_ID_COLUMN_POSITION,SUBJECT,"_"); \
			print SUBJECT[1],SUBJECT[2],$SUBJECT_ID_COLUMN_POSITION,$SM_TAG_COLUMN_POSITION,$PROJECT_COLUMN_POSITION}' \
		${QC_REPORT} \
			| sort \
	...
	BUILD_HOLD_ID_PATH_PROJECT_WRAP_UP ()
	{
		...
		for TUMOR_SM_TAG in \
			$(awk \
				...
				-v SM_TAG_COLUMN_POSITION="$SM_TAG_COLUMN_POSITION" \
				'BEGIN {FS=",";OFS="\t"} \
				$PROJECT_COLUMN_POSITION=="'${PROJECT}'"
				{split($SUBJECT_ID_COLUMN_POSITION,SUBJECT,"_"); \
				print $SM_TAG_COLUMN_POSITION,SUBJECT[2]}' \
			${QC_REPORT} \
			| awk '$2=="T"||$2=="C"||$2=="S" \
				{print $1}' \
			| sort \
