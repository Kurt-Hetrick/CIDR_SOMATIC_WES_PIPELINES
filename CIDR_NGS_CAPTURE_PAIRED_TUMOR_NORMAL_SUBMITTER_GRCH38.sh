...
##################################
	...
	MAKE_PROJ_DIR_TREE ()
	{
		...
		${CORE_PATH}/${SEQ_PROJECT}/VCF/MUTECT2/STATS
	}
...
do
	...
	do
		...
		HOLD_ID_PATH_MERGE_STATS="${HOLD_ID_PATH_MERGE_STATS}B02-MUTECT2_${TUMOR_INDIVIDUAL}_${TUMOR_SM_TAG}_${TUMOR_PROJECT}_chr${CHROMOSOME},"

		HOLD_ID_PATH_MERGE_STATS=$(echo ${HOLD_ID_PATH_MERGE_STATS} | sed 's/@/_/g')

		HOLD_ID_PATH_F1R2_GATHER="${HOLD_ID_PATH_F1R2_GATHER}A01-MUTECT2_${TUMOR_INDIVIDUAL}_${TUMOR_SM_TAG}_chr${CHROMOSOME},"

		HOLD_ID_PATH_F1R2_GATHER=$(echo ${HOLD_ID_PATH_F1R2_GATHER} | sed 's/@/_/g')

		HOLD_ID_PATH_CAT_MUTECT2_VCF="${HOLD_ID_PATH_CAT_MUTECT2_VCF}A01-MUTECT2_${TUMOR_INDIVIDUAL}_${TUMOR_SM_TAG}_chr${CHROMOSOME},"
